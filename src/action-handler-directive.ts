...
if (!customElements.get('action-handler-bolder-container')) {
  customElements.define('action-handler-bolder-container', ActionHandler)
}

const getActionHandler = (): ActionHandler => {
  const body = document.body
  if (body.querySelector('action-handler-bolder-container')) {
    // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
    return body.querySelector('action-handler-bolder-container')!
  }

  const actionhandler = document.createElement('action-handler-bolder-container')
