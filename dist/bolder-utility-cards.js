 ...
 * http://polymer.github.io/PATENTS.txt
 */
function Te(e){let t=Pe.get(e.type);void 0===t&&(t={stringsArray:new WeakMap,keyString:new Map},Pe.set(e.type,t));let r=t.stringsArray.get(e.strings);if(void 0!==r)return r;const o=e.strings.join(de);return r=t.keyString.get(o),void 0===r&&(r=new pe(e,e.getTemplateElement()),t.keyString.set(o,r)),t.stringsArray.set(e.strings,r),r}(()=>{try{const e={get capture(){return ze=!0,!1}};window.addEventListener("test",e,e),window.removeEventListener("test",e,e)}catch(e){}})();const Pe=new Map,Me=new WeakMap;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */var Jr;null===(Jr=window.HTMLSlotElement)||void 0===Jr||Jr.prototype.assignedElements;var Xr,Qr=Number.isNaN||function(e){return"number"==typeof e&&e!=e};function Yr(e,t){if(e.length!==t.length)return!1;for(var r=0;r<e.length;r++)if(o=e[r],i=t[r],!(o===i||Qr(o)&&Qr(i)))return!1;var o,i;return!0}let eo=Xr=class extends ne{setConfig(e){this.config=e}getLocale(){var e,t;return null!==(t=null!==(e=this.config.locale)&&void 0!==e?e:this.hass.locale.language)&&void 0!==t?t:"en-GB"}render(){if(!this.hass)return j;const e=[{name:"header",type:"expandable",flatten:!0,expanded:!0,locale:this.getLocale(),schema:Xr._schema(this.getLocale())}];return L`
      <ha-form
      .hass=${this.hass}
      .data=${this.config}
      .schema=${e}
      ...
      ></ha-form>
    `}valueChanged(e){if(!this.config||!this.hass)return;const t=Object.assign({},this.config);Xr.getConfigFromValueChangedObject(t,e.detail.value),this.config=t;const r=new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0});this.dispatchEvent(r)}static getConfigFromValueChangedObject(e,t){e.title=t.title,e.subtitle=t.subtitle,e.icon=t.icon,e.styles=t.styles}localize(e,t){return Ir("editor."+e,t)}};eo._schema=function(e,t){void 0===t&&(t=Yr);var r=null;function o(){for(var o=[],i=0;i<arguments.length;i++)o[i]=arguments[i];if(r&&r.lastThis===this&&t(o,r.lastArgs))return r.lastResult;var n=e.apply(this,o);return r={lastResult:n,lastArgs:o,lastThis:this},n}return o.clear=function(){r=null},o}((e=>[{name:"title",locale:e,selector:{text:{}}},{name:"subtitle",locale:e,selector:{text:{}}},{name:"icon",locale:e,selector:{icon:{}}}])),e([qr({attribute:!1})],eo.prototype,"hass",void 0),e([Zr()],eo.prototype,"config",void 0),eo=Xr=e([Dr("bolder-header-card-editor")],eo);var to=Object.freeze({__proto__:null,get BolderHeaderCardEditor(){return eo}});function ro(e){if(!e||"object"!=typeof e)return e;if("[object Date]"==Object.prototype.toString.call(e))return new Date(e.getTime());if(Array.isArray(e))return e.map(ro);var t={};return Object.keys(e).forEach((function(r){t[r]=ro(e[r])})),t}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let oo=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,r){this._$Ct=e,this._$AM=t,this._$Ci=r}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const io={},no=(e=>(...t)=>({_$litDirective$:e,values:t}))(class extends oo{constructor(){super(...arguments),this.key=j}render(e,t){return this.key=e,t}update(e,[t,r]){return t!==this.key&&(((e,t=io)=>{e._$AH=t;
/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */})(e),this.key=t),r}}),ao=globalThis,so=ao.ShadowRoot&&(void 0===ao.ShadyCSS||ao.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,lo=Symbol(),co=new WeakMap;let ho=class{constructor(e,t,r){if(this._$cssResult$=!0,r!==lo)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(so&&void 0===e){const r=void 0!==t&&1===t.length;r&&(e=co.get(t)),void 0===e&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),r&&co.set(t,e))}return e}toString(){return this.cssText}};const uo=(e,...t)=>{const r=1===e.length?e[0]:t.reduce(((t,r,o)=>t+(e=>{if(!0===e._$cssResult$)return e.cssText;if("number"==typeof e)return e;throw Error("Value passed to 'css' function must be a 'css' function result: "+e+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(r)+e[o+1]),e[0]);return new ho(r,e,lo)},po=so?e=>e:e=>e instanceof CSSStyleSheet?(e=>{let t="";for(const r of e.cssRules)t+=r.cssText;return(e=>new ho("string"==typeof e?e:e+"",void 0,lo))(t)})(e):e
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */,{is:_o,defineProperty:bo,getOwnPropertyDescriptor:go,getOwnPropertyNames:vo,getOwnPropertySymbols:fo,getPrototypeOf:mo}=Object,yo=globalThis,ko=yo.trustedTypes,wo=ko?ko.emptyScript:"",Co=yo.reactiveElementPolyfillSupport,$o=(e,t)=>e,So={toAttribute(e,t){switch(t){case Boolean:e=e?wo:null;break;case Object:case Array:e=null==e?e:JSON.stringify(e)}return e},fromAttribute(e,t){let r=e;switch(t){case Boolean:r=null!==e;break;case Number:r=null===e?null:Number(e);break;case Object:case Array:try{r=JSON.parse(e)}catch(e){r=null}}return r}},xo=(e,t)=>!_o(e,t),Ao={attribute:!0,type:String,converter:So,reflect:!1,useDefault:!1,hasChanged:xo};Symbol.metadata??=Symbol("metadata"),yo.litPropertyMetadata??=new WeakMap;let Eo=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=Ao){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){const r=Symbol(),o=this.getPropertyDescriptor(e,r,t);void 0!==o&&bo(this.prototype,e,o)}}static getPropertyDescriptor(e,t,r){const{get:o,set:i}=go(this.prototype,e)??{get(){return this[t]},set(e){this[t]=e}};return{get:o,set(t){const n=o?.call(this);i?.call(this,t),this.requestUpdate(e,n,r)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Ao}static _$Ei(){if(this.hasOwnProperty($o("elementProperties")))return;const e=mo(this);e.finalize(),void 0!==e.l&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty($o("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty($o("properties"))){const e=this.properties,t=[...vo(e),...fo(e)];for(const r of t)this.createProperty(r,e[r])}const e=this[Symbol.metadata];if(null!==e){const t=litPropertyMetadata.get(e);if(void 0!==t)for(const[e,r]of t)this.elementProperties.set(e,r)}this._$Eh=new Map;for(const[e,t]of this.elementProperties){const r=this._$Eu(e,t);void 0!==r&&this._$Eh.set(r,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const r=new Set(e.flat(1/0).reverse());for(const e of r)t.unshift(po(e))}else void 0!==e&&t.push(po(e));return t}static _$Eu(e,t){const r=t.attribute;return!1===r?void 0:"string"==typeof r?r:"string"==typeof e?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise((e=>this.enableUpdating=e)),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach((e=>e(this)))}addController(e){(this._$EO??=new Set).add(e),void 0!==this.renderRoot&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){const e=new Map,t=this.constructor.elementProperties;for(const r of t.keys())this.hasOwnProperty(r)&&(e.set(r,this[r]),delete this[r]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return((e,t)=>{if(so)e.adoptedStyleSheets=t.map((e=>e instanceof CSSStyleSheet?e:e.styleSheet));else for(const r of t){const t=document.createElement("style"),o=ao.litNonce;void 0!==o&&t.setAttribute("nonce",o),t.textContent=r.cssText,e.appendChild(t)}})(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach((e=>e.hostConnected?.()))}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach((e=>e.hostDisconnected?.()))}attributeChangedCallback(e,t,r){this._$AK(e,r)}_$ET(e,t){const r=this.constructor.elementProperties.get(e),o=this.constructor._$Eu(e,r);if(void 0!==o&&!0===r.reflect){const i=(void 0!==r.converter?.toAttribute?r.converter:So).toAttribute(t,r.type);this._$Em=e,null==i?this.removeAttribute(o):this.setAttribute(o,i),this._$Em=null}}_$AK(e,t){const r=this.constructor,o=r._$Eh.get(e);if(void 0!==o&&this._$Em!==o){const e=r.getPropertyOptions(o),i="function"==typeof e.converter?{fromAttribute:e.converter}:void 0!==e.converter?.fromAttribute?e.converter:So;this._$Em=o,this[o]=i.fromAttribute(t,e.type)??this._$Ej?.get(o)??null,this._$Em=null}}requestUpdate(e,t,r){if(void 0!==e){const o=this.constructor,i=this[e];if(r??=o.getPropertyOptions(e),!((r.hasChanged??xo)(i,t)||r.useDefault&&r.reflect&&i===this._$Ej?.get(e)&&!this.hasAttribute(o._$Eu(e,r))))return;this.C(e,t,r)}!1===this.isUpdatePending&&(this._$ES=this._$EP())}C(e,t,{useDefault:r,reflect:o,wrapped:i},n){r&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,n??t??this[e]),!0!==i||void 0!==n)||(this._$AL.has(e)||(this.hasUpdated||r||(t=void 0),this._$AL.set(e,t)),!0===o&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}const e=this.scheduleUpdate();return null!=e&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[e,t]of this._$Ep)this[e]=t;this._$Ep=void 0}const e=this.constructor.elementProperties;if(e.size>0)for(const[t,r]of e){const{wrapped:e}=r,o=this[t];!0!==e||this._$AL.has(t)||void 0===o||this.C(t,void 0,r,o)}}let e=!1;const t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach((e=>e.hostUpdate?.())),this.update(t)):this._$EM()}catch(t){throw e=!1,this._$EM(),t}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach((e=>e.hostUpdated?.())),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach((e=>this._$ET(e,this[e]))),this._$EM()}updated(e){}firstUpdated(e){}};Eo.elementStyles=[],Eo.shadowRootOptions={mode:"open"},Eo[$o("elementProperties")]=new Map,Eo[$o("finalized")]=new Map,Co?.({ReactiveElement:Eo}),(yo.reactiveElementVersions??=[]).push("2.1.0");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Oo=globalThis,zo=Oo.trustedTypes,To=zo?zo.createPolicy("lit-html",{createHTML:e=>e}):void 0,Po="$lit$",Mo=`lit$${Math.random().toFixed(9).slice(2)}$`,Bo="?"+Mo,Ko=`<${Bo}>`,Ho=document,Io=()=>Ho.createComment(""),Ro=e=>null===e||"object"!=typeof e&&"function"!=typeof e,No=Array.isArray,Lo="[ \t\n\f\r]",Uo=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,jo=/-->/g,Vo=/>/g,Do=RegExp(`>|${Lo}(?:([^\\s"'>=/]+)(${Lo}*=${Lo}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),Fo=/'/g,Wo=/"/g,qo=/^(?:script|style|textarea|title)$/i,Zo=(e=>(t,...r)=>({_$litType$:e,strings:t,values:r}))(1),Go=Symbol.for("lit-noChange"),Jo=Symbol.for("lit-nothing"),Xo=new WeakMap,Qo=Ho.createTreeWalker(Ho,129);function Yo(e,t){if(!No(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==To?To.createHTML(t):t}const ei=(e,t)=>{const r=e.length-1,o=[];let i,n=2===t?"<svg>":3===t?"<math>":"",a=Uo;for(let t=0;t<r;t++){const r=e[t];let s,l,d=-1,c=0;for(;c<r.length&&(a.lastIndex=c,l=a.exec(r),null!==l);)c=a.lastIndex,a===Uo?"!--"===l[1]?a=jo:void 0!==l[1]?a=Vo:void 0!==l[2]?(qo.test(l[2])&&(i=RegExp("</"+l[2],"g")),a=Do):void 0!==l[3]&&(a=Do):a===Do?">"===l[0]?(a=i??Uo,d=-1):void 0===l[1]?d=-2:(d=a.lastIndex-l[2].length,s=l[1],a=void 0===l[3]?Do:'"'===l[3]?Wo:Fo):a===Wo||a===Fo?a=Do:a===jo||a===Vo?a=Uo:(a=Do,i=void 0);const h=a===Do&&e[t+1].startsWith("/>")?" ":"";n+=a===Uo?r+Ko:d>=0?(o.push(s),r.slice(0,d)+Po+r.slice(d)+Mo+h):r+Mo+(-2===d?t:h)}return[Yo(e,n+(e[r]||"<?>")+(2===t?"</svg>":3===t?"</math>":"")),o]};class ti{constructor({strings:e,_$litType$:t},r){let o;this.parts=[];let i=0,n=0;const a=e.length-1,s=this.parts,[l,d]=ei(e,t);if(this.el=ti.createElement(l,r),Qo.currentNode=this.el.content,2===t||3===t){const e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;null!==(o=Qo.nextNode())&&s.length<a;){if(1===o.nodeType){if(o.hasAttributes())for(const e of o.getAttributeNames())if(e.endsWith(Po)){const t=d[n++],r=o.getAttribute(e).split(Mo),a=/([.?@])?(.*)/.exec(t);s.push({type:1,index:i,name:a[2],strings:r,ctor:"."===a[1]?ai:"?"===a[1]?si:"@"===a[1]?li:ni}),o.removeAttribute(e)}else e.startsWith(Mo)&&(s.push({type:6,index:i}),o.removeAttribute(e));if(qo.test(o.tagName)){const e=o.textContent.split(Mo),t=e.length-1;if(t>0){o.textContent=zo?zo.emptyScript:"";for(let r=0;r<t;r++)o.append(e[r],Io()),Qo.nextNode(),s.push({type:2,index:++i});o.append(e[t],Io())}}}else if(8===o.nodeType)if(o.data===Bo)s.push({type:2,index:i});else{let e=-1;for(;-1!==(e=o.data.indexOf(Mo,e+1));)s.push({type:7,index:i}),e+=Mo.length-1}i++}}static createElement(e,t){const r=Ho.createElement("template");return r.innerHTML=e,r}}function ri(e,t,r=e,o){if(t===Go)return t;let i=void 0!==o?r._$Co?.[o]:r._$Cl;const n=Ro(t)?void 0:t._$litDirective$;return i?.constructor!==n&&(i?._$AO?.(!1),void 0===n?i=void 0:(i=new n(e),i._$AT(e,r,o)),void 0!==o?(r._$Co??=[])[o]=i:r._$Cl=i),void 0!==i&&(t=ri(e,i._$AS(e,t.values),i,o)),t}class oi{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:r}=this._$AD,o=(e?.creationScope??Ho).importNode(t,!0);Qo.currentNode=o;let i=Qo.nextNode(),n=0,a=0,s=r[0];for(;void 0!==s;){if(n===s.index){let t;2===s.type?t=new ii(i,i.nextSibling,this,e):1===s.type?t=new s.ctor(i,s.name,s.strings,this,e):6===s.type&&(t=new di(i,this,e)),this._$AV.push(t),s=r[++a]}n!==s?.index&&(i=Qo.nextNode(),n++)}return Qo.currentNode=Ho,o}p(e){let t=0;for(const r of this._$AV)void 0!==r&&(void 0!==r.strings?(r._$AI(e,r,t),t+=r.strings.length-2):r._$AI(e[t])),t++}}class ii{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,r,o){this.type=2,this._$AH=Jo,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=r,this.options=o,this._$Cv=o?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return void 0!==t&&11===e?.nodeType&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=ri(this,e,t),Ro(e)?e===Jo||null==e||""===e?(this._$AH!==Jo&&this._$AR(),this._$AH=Jo):e!==this._$AH&&e!==Go&&this._(e):void 0!==e._$litType$?this.$(e):void 0!==e.nodeType?this.T(e):(e=>No(e)||"function"==typeof e?.[Symbol.iterator])(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==Jo&&Ro(this._$AH)?this._$AA.nextSibling.data=e:this.T(Ho.createTextNode(e)),this._$AH=e}$(e){const{values:t,_$litType$:r}=e,o="number"==typeof r?this._$AC(e):(void 0===r.el&&(r.el=ti.createElement(Yo(r.h,r.h[0]),this.options)),r);if(this._$AH?._$AD===o)this._$AH.p(t);else{const e=new oi(o,this),r=e.u(this.options);e.p(t),this.T(r),this._$AH=e}}_$AC(e){let t=Xo.get(e.strings);return void 0===t&&Xo.set(e.strings,t=new ti(e)),t}k(e){No(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let r,o=0;for(const i of e)o===t.length?t.push(r=new ii(this.O(Io()),this.O(Io()),this,this.options)):r=t[o],r._$AI(i),o++;o<t.length&&(this._$AR(r&&r._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e&&e!==this._$AB;){const t=e.nextSibling;e.remove(),e=t}}setConnected(e){void 0===this._$AM&&(this._$Cv=e,this._$AP?.(e))}}class ni{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,r,o,i){this.type=1,this._$AH=Jo,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=i,r.length>2||""!==r[0]||""!==r[1]?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=Jo}_$AI(e,t=this,r,o){const i=this.strings;let n=!1;if(void 0===i)e=ri(this,e,t,0),n=!Ro(e)||e!==this._$AH&&e!==Go,n&&(this._$AH=e);else{const o=e;let a,s;for(e=i[0],a=0;a<i.length-1;a++)s=ri(this,o[r+a],t,a),s===Go&&(s=this._$AH[a]),n||=!Ro(s)||s!==this._$AH[a],s===Jo?e=Jo:e!==Jo&&(e+=(s??"")+i[a+1]),this._$AH[a]=s}n&&!o&&this.j(e)}j(e){e===Jo?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class ai extends ni{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===Jo?void 0:e}}class si extends ni{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==Jo)}}class li extends ni{constructor(e,t,r,o,i){super(e,t,r,o,i),this.type=5}_$AI(e,t=this){if((e=ri(this,e,t,0)??Jo)===Go)return;const r=this._$AH,o=e===Jo&&r!==Jo||e.capture!==r.capture||e.once!==r.once||e.passive!==r.passive,i=e!==Jo&&(r===Jo||o);o&&this.element.removeEventListener(this.name,this,r),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class di{constructor(e,t,r){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(e){ri(this,e)}}const ci=Oo.litHtmlPolyfillSupport;ci?.(ti,ii),(Oo.litHtmlVersions??=[]).push("3.3.0");const hi=globalThis;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let ui=class extends Eo{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=((e,t,r)=>{const o=r?.renderBefore??t;let i=o._$litPart$;if(void 0===i){const e=r?.renderBefore??null;o._$litPart$=i=new ii(t.insertBefore(Io(),e),e,void 0,r??{})}return i._$AI(e),i})(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return Go}};ui._$litElement$=!0,ui.finalized=!0,hi.litElementHydrateSupport?.({LitElement:ui});const pi=hi.litElementPolyfillSupport;pi?.({LitElement:ui}),(hi.litElementVersions??=[]).push("4.2.0");var _i=uo`
  :host {
...
`,gi=Object.defineProperty,vi=Object.getOwnPropertyDescriptor,fi=Object.getOwnPropertySymbols,mi=Object.prototype.hasOwnProperty,yi=Object.prototype.propertyIsEnumerable,ki=e=>{throw TypeError(e)},wi=(e,t,r)=>t in e?gi(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,Ci=(e,t)=>{for(var r in t||(t={}))mi.call(t,r)&&wi(e,r,t[r]);if(fi)for(var r of fi(t))yi.call(t,r)&&wi(e,r,t[r]);return e},$i=(e,t,r,o)=>{for(var i,n=o>1?void 0:o?vi(t,r):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(o?i(t,r,n):i(n))||n);return o&&n&&gi(t,r,n),n},Si=(e,t,r)=>t.has(e)||ki("Cannot "+r);function xi(e,t){const r=Ci({waitUntilFirstUpdate:!1},t);return(t,o)=>{const{update:i}=t,n=Array.isArray(e)?e:[e];t.update=function(e){n.forEach((t=>{const i=t;if(e.has(i)){const t=e.get(i),n=this[i];t!==n&&(r.waitUntilFirstUpdate&&!this.hasUpdated||this[o](t,n))}})),i.call(this,e)}}}var Ai=uo`
  :host {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
function Pi(e,t){return(t,r,o)=>((e,t,r)=>(r.configurable=!0,r.enumerable=!0,Reflect.decorate&&"object"!=typeof t&&Object.defineProperty(e,t,r),r))(t,r,{get(){return(t=>t.renderRoot?.querySelector(e)??null)(this)}})}var Mi,Bi=class extends ui{constructor(){var e,t,r;super(),e=this,r=!1,(t=Mi).has(e)?ki("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),this.initialReflectedProperties=new Map,Object.entries(this.constructor.dependencies).forEach((([e,t])=>{this.constructor.define(e,t)}))}emit(e,t){const r=new CustomEvent(e,Ci({bubbles:!0,cancelable:!1,composed:!0,detail:{}},t));return this.dispatchEvent(r),r}static define(e,t=this,r={}){const o=customElements.get(e);if(!o){try{customElements.define(e,t,r)}catch(o){customElements.define(e,class extends t{},r)}return}let i=" (unknown version)",n=i;"version"in t&&t.version&&(i=" v"+t.version),"version"in o&&o.version&&(n=" v"+o.version),i&&n&&i===n||console.warn(`Attempted to register <${e}>${i}, but <${e}>${n} has already been registered.`)}attributeChangedCallback(e,t,r){var o,i;Si(o=this,i=Mi,"read from private field"),i.get(o)||(this.constructor.elementProperties.forEach(((e,t)=>{e.reflect&&null!=this[t]&&this.initialReflectedProperties.set(t,this[t])})),((e,t,r,o)=>{Si(e,t,"write to private field"),t.set(e,r)})(this,Mi,!0)),super.attributeChangedCallback(e,t,r)}willUpdate(e){super.willUpdate(e),this.initialReflectedProperties.forEach(((t,r)=>{e.has(r)&&null==this[r]&&(this[r]=t)}))}};Mi=new WeakMap,Bi.version="2.20.1",Bi.dependencies={},$i([zi()],Bi.prototype,"dir",2),$i([zi()],Bi.prototype,"lang",2);var Ki=class extends Bi{constructor(){super(...arguments),this.observedElements=[],this.disabled=!1}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver((e=>{this.emit("sl-resize",{detail:{entries:e}})})),this.disabled||this.startObserver()}disconnectedCallback(){super.disconnectedCallback(),this.stopObserver()}handleSlotChange(){this.disabled||this.startObserver()}startObserver(){const e=this.shadowRoot.querySelector("slot");if(null!==e){const t=e.assignedElements({flatten:!0});this.observedElements.forEach((e=>this.resizeObserver.unobserve(e))),this.observedElements=[],t.forEach((e=>{this.resizeObserver.observe(e),this.observedElements.push(e)}))}}stopObserver(){this.resizeObserver.disconnect()}handleDisabledChange(){this.disabled?this.stopObserver():this.startObserver()}render(){return Zo` <slot @slotchange=${this.handleSlotChange}></slot> `}};function Hi(e,t,r="vertical",o="smooth"){const i=function(e,t){return{top:Math.round(e.getBoundingClientRect().top-t.getBoundingClientRect().top),left:Math.round(e.getBoundingClientRect().left-t.getBoundingClientRect().left)}}(e,t),n=i.top+t.scrollTop,a=i.left+t.scrollLeft,s=t.scrollLeft,l=t.scrollLeft+t.offsetWidth,d=t.scrollTop,c=t.scrollTop+t.offsetHeight;"horizontal"!==r&&"both"!==r||(a<s?t.scrollTo({left:a,behavior:o}):a+e.clientWidth>l&&t.scrollTo({left:a-t.offsetWidth+e.clientWidth,behavior:o})),"vertical"!==r&&"both"!==r||(n<d?t.scrollTo({top:n,behavior:o}):n+e.clientHeight>c&&t.scrollTo({top:n-t.offsetHeight+e.clientHeight,behavior:o}))}Ki.styles=[Ai,bi],$i([zi({type:Boolean,reflect:!0})],Ki.prototype,"disabled",2),$i([xi("disabled",{waitUntilFirstUpdate:!0})],Ki.prototype,"handleDisabledChange",1);var Ii=uo`
  :host {
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */;var Wi,qi=Symbol(),Zi=Symbol(),Gi=new Map,Ji=class extends Bi{constructor(){super(...arguments),this.initialRender=!1,this.svg=null,this.label="",this.library="default"}async resolveIcon(e,t){var r;let o;if(null==t?void 0:t.spriteSheet)return this.svg=Zo`<svg part="svg">
        <use part="use" href="${e}"></use>
      </svg>`,this.svg;try{if(o=await fetch(e,{mode:"cors"}),!o.ok)return 410===o.status?qi:Zi}catch(e){return Zi}try{const e=document.createElement("div");e.innerHTML=await o.text();const t=e.firstElementChild;if("svg"!==(null==(r=null==t?void 0:t.tagName)?void 0:r.toLowerCase()))return qi;Wi||(Wi=new DOMParser);const i=Wi.parseFromString(t.outerHTML,"text/html").body.querySelector("svg");return i?(i.part.add("svg"),document.adoptNode(i)):qi}catch(e){return qi}}connectedCallback(){var e;super.connectedCallback(),e=this,Vi.push(e)}firstUpdated(){this.initialRender=!0,this.setIcon()}disconnectedCallback(){var e;super.disconnectedCallback(),e=this,Vi=Vi.filter((t=>t!==e))}getIconSource(){const e=Di(this.library);return this.name&&e?{url:e.resolver(this.name),fromLibrary:!0}:{url:this.src,fromLibrary:!1}}handleLabelChange(){"string"==typeof this.label&&this.label.length>0?(this.setAttribute("role","img"),this.setAttribute("aria-label",this.label),this.removeAttribute("aria-hidden")):(this.removeAttribute("role"),this.removeAttribute("aria-label"),this.setAttribute("aria-hidden","true"))}async setIcon(){var e;const{url:t,fromLibrary:r}=this.getIconSource(),o=r?Di(this.library):void 0;if(!t)return void(this.svg=null);let i=Gi.get(t);if(i||(i=this.resolveIcon(t,o),Gi.set(t,i)),!this.initialRender)return;const n=await i;if(n===Zi&&Gi.delete(t),t===this.getIconSource().url)if(((e,t)=>void 0!==e?._$litType$)(n)){if(this.svg=n,o){await this.updateComplete;const e=this.shadowRoot.querySelector("[part='svg']");"function"==typeof o.mutator&&e&&o.mutator(e)}}else switch(n){case Zi:case qi:this.svg=null,this.emit("sl-error");break;default:this.svg=n.cloneNode(!0),null==(e=null==o?void 0:o.mutator)||e.call(o,this.svg),this.emit("sl-load")}}render(){return this.svg}};Ji.styles=[Ai,Fi],$i([Ti()],Ji.prototype,"svg",2),$i([zi({reflect:!0})],Ji.prototype,"name",2),$i([zi()],Ji.prototype,"src",2),$i([zi()],Ji.prototype,"label",2),$i([zi({reflect:!0})],Ji.prototype,"library",2),$i([xi("label")],Ji.prototype,"handleLabelChange",1),$i([xi(["name","src","library"])],Ji.prototype,"setIcon",1);
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Xi=1;let Qi=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,r){this._$Ct=e,this._$AM=t,this._$Ci=r}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Yi=(e=>(...t)=>({_$litDirective$:e,values:t}))(class extends Qi{constructor(e){if(super(e),e.type!==Xi||"class"!==e.name||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter((t=>e[t])).join(" ")+" "}update(e,[t]){if(void 0===this.st){this.st=new Set,void 0!==e.strings&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter((e=>""!==e))));for(const e in t)t[e]&&!this.nt?.has(e)&&this.st.add(e);return this.render(t)}const r=e.element.classList;for(const e of this.st)e in t||(r.remove(e),this.st.delete(e));for(const e in t){const o=!!t[e];o===this.st.has(e)||this.nt?.has(e)||(o?(r.add(e),this.st.add(e)):(r.remove(e),this.st.delete(e)))}return Go}}),en=Symbol.for(""),tn=e=>{if(e?.r===en)return e?._$litStatic$},rn=(e,...t)=>({_$litStatic$:t.reduce(((t,r,o)=>t+(e=>{if(void 0!==e._$litStatic$)return e._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${e}. Use 'unsafeStatic' to pass non-literal values, but\n            take care to ensure page security.`)})(r)+e[o+1]),e[0]),r:en}),on=new Map,nn=(e=>(t,...r)=>{const o=r.length;let i,n;const a=[],s=[];let l,d=0,c=!1;for(;d<o;){for(l=t[d];d<o&&void 0!==(n=r[d],i=tn(n));)l+=i+t[++d],c=!0;d!==o&&s.push(n),a.push(l),d++}if(d===o&&a.push(t[o]),c){const e=a.join("$$lit$$");void 0===(t=on.get(e))&&(a.raw=a,on.set(e,t=a)),r=s}return e(t,...r)})(Zo),an=e=>e??Jo;
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var sn=class extends Bi{constructor(){super(...arguments),this.hasFocus=!1,this.label="",this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(e){this.disabled&&(e.preventDefault(),e.stopPropagation())}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}render(){const e=!!this.href,t=e?rn`a`:rn`button`;return nn`
      <${t}
        part="base"
        class=${Yi({"icon-button":!0,"icon-button--disabled":!e&&this.disabled,"icon-button--focused":this.hasFocus})}
        ?disabled=${an(e?void 0:this.disabled)}
        type=${an(e?void 0:"button")}
        href=${an(e?this.href:void 0)}
        target=${an(e?this.target:void 0)}
        download=${an(e?this.download:void 0)}
        rel=${an(e&&this.target?"noreferrer noopener":void 0)}
        ...
        <div class="tab-group__nav-container" part="nav">
          ...
          ${this.hasScrollControls?Zo`
                <sl-icon-button
                  ...
                  exportparts="base:scroll-button__base"
                  class=${Yi({"tab-group__scroll-button":!0,"tab-group__scroll-button--end":!0,"tab-group__scroll-button--end--hidden":this.shouldHideScrollEndButton})}
    ...
    `}};yn.styles=[Ai,_i],yn.dependencies={"sl-icon-button":sn,"sl-resize-observer":Ki},$i([Pi(".tab-group")],yn.prototype,"tabGroup",2),$i([Pi(".tab-group__body")],yn.prototype,"body",2),$i([Pi(".tab-group__nav")],yn.prototype,"nav",2),$i([Pi(".tab-group__indicator")],yn.prototype,"indicator",2),$i([Ti()],yn.prototype,"hasScrollControls",2),$i([Ti()],yn.prototype,"shouldHideScrollStartButton",2),$i([Ti()],yn.prototype,"shouldHideScrollEndButton",2),$i([zi()],yn.prototype,"placement",2),$i([zi()],yn.prototype,"activation",2),$i([zi({attribute:"no-scroll-controls",type:Boolean})],yn.prototype,"noScrollControls",2),$i([zi({attribute:"fixed-scroll-controls",type:Boolean})],yn.prototype,"fixedScrollControls",2),$i([function(e){return(t,r)=>{const o="function"==typeof t?t:t[r];Object.assign(o,e)}}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */({passive:!0})],yn.prototype,"updateScrollButtons",1),$i([xi("noScrollControls",{waitUntilFirstUpdate:!0})],yn.prototype,"updateScrollControls",1),$i([xi("placement",{waitUntilFirstUpdate:!0})],yn.prototype,"syncIndicator",1);var kn=(e,t)=>{let r=0;return function(...o){window.clearTimeout(r),r=window.setTimeout((()=>{e.call(this,...o)}),t)}},wn=(e,t,r)=>{const o=e[t];e[t]=function(...e){o.call(this,...e),r.call(this,o,...e)}};(()=>{if("undefined"==typeof window)return;if(!("onscrollend"in window)){const e=new Set,t=new WeakMap,r=t=>{for(const r of t.changedTouches)e.add(r.identifier)},o=t=>{for(const r of t.changedTouches)e.delete(r.identifier)};document.addEventListener("touchstart",r,!0),document.addEventListener("touchend",o,!0),document.addEventListener("touchcancel",o,!0),wn(EventTarget.prototype,"addEventListener",(function(r,o){if("scrollend"!==o)return;const i=kn((()=>{e.size?i():this.dispatchEvent(new Event("scrollend"))}),100);r.call(this,"scroll",i,{passive:!0}),t.set(this,i)})),wn(EventTarget.prototype,"removeEventListener",(function(e,r){if("scrollend"!==r)return;const o=t.get(this);o&&e.call(this,"scroll",o,{passive:!0})}))}})();var Cn=uo`
  :host {
    display: inline-block;
  }
...
`,$n=0,Sn=class extends Bi{constructor(){super(...arguments),this.localize=new mn(this),this.attrId=++$n,this.componentId=`sl-tab-${this.attrId}`,this.panel="",this.active=!1,this.closable=!1,this.disabled=!1,this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.setAttribute("role","tab")}handleCloseClick(e){e.stopPropagation(),this.emit("sl-close")}handleActiveChange(){this.setAttribute("aria-selected",this.active?"true":"false")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false"),this.disabled&&!this.active?this.tabIndex=-1:this.tabIndex=0}render(){return this.id=this.id.length>0?this.id:this.componentId,Zo`
      <div
        part="base"
        class=${Yi({tab:!0,"tab--active":this.active,"tab--closable":this.closable,"tab--disabled":this.disabled})}
      >
        <slot></slot>
        ${this.closable?Zo`
              <sl-icon-button
    ...
    `}};Sn.styles=[Ai,Cn],Sn.dependencies={"sl-icon-button":sn},$i([Pi(".tab")],Sn.prototype,"tab",2),$i([zi({reflect:!0})],Sn.prototype,"panel",2),$i([zi({type:Boolean,reflect:!0})],Sn.prototype,"active",2),$i([zi({type:Boolean,reflect:!0})],Sn.prototype,"closable",2),$i([zi({type:Boolean,reflect:!0})],Sn.prototype,"disabled",2),$i([zi({type:Number,reflect:!0})],Sn.prototype,"tabIndex",2),$i([xi("active")],Sn.prototype,"handleActiveChange",1),$i([xi("disabled")],Sn.prototype,"handleDisabledChange",1),Sn.define("sl-tab");let xn=class extends yn{constructor(){super(...arguments),this._mouseIsDown=!1,this._scrolled=!1,this._scrollStartX=0,this._scrollLeft=0,this._mouseDown=e=>{const t=this._scrollContainer;t&&(this._scrollStartX=e.pageX-t.offsetLeft,this._scrollLeft=t.scrollLeft,this._mouseIsDown=!0,this._scrolled=!1,window.addEventListener("mousemove",this._mouseMove),window.addEventListener("mouseup",this._mouseUp,{once:!0}))},this._mouseUp=()=>{this._mouseIsDown=!1,this._scrolled&&(this._mouseReleasedAt=(new Date).getTime()),window.removeEventListener("mousemove",this._mouseMove)},this._mouseMove=e=>{if(!this._mouseIsDown)return;const t=this._scrollContainer;if(!t)return;const r=e.pageX-t.offsetLeft-this._scrollStartX;this._scrolled||(this._scrolled=Math.abs(r)>1),t.scrollLeft=this._scrollLeft-r}}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousemove",this._mouseMove),window.removeEventListener("mouseup",this._mouseUp)}setAriaLabels(){}getAllPanels(){return[]}firstUpdated(e){super.firstUpdated(e);const t=this._scrollContainer;t&&t.addEventListener("mousedown",this._mouseDown)}handleClick(e){this._mouseReleasedAt&&(new Date).getTime()-this._mouseReleasedAt<100||super.handleClick(e)}};xn.styles=[_i,l`
      :host {
    ...
    `],e([Gr(".tab-group__nav",!0)],xn.prototype,"_scrollContainer",void 0),xn=e([Dr("sl-tab-group")],xn);let An=class extends ne{constructor(){super(...arguments),this._selectedCard=0,this._GUImode=!0,this._guiModeAvailable=!0,this._keys=new Map}setConfig(e){this.config=e,this.config.header&&e.header&&(this.config.header.styles=e.header.styles)}formData(){return this.config}render(){var e,t,r,o,i,n,a,s,l,d;if(!this.hass||!this.config)return j;const c=this._selectedCard,h=null!==(t=null===(e=this.config.cards)||void 0===e?void 0:e.length)&&void 0!==t?t:0,u=this._GUImode,p=[{title:this.localize("container_card_settings",this.getLocale()),type:"expandable",flatten:!1,expanded:!1,locale:this.getLocale(),schema:[{name:"mode",locale:this.getLocale(),selector:{select:{multiple:!1,options:[{label:this.localize("vertical",this.getLocale()),value:"vertical"},{label:this.localize("horizontal",this.getLocale()),value:"horizontal"}]}}},{name:"is_inner_container",locale:this.getLocale(),selector:{boolean:{}}},{name:"header",type:"expandable",flatten:!1,expanded:!1,locale:this.getLocale(),schema:eo._schema(this.getLocale())},{title:this.localize("keep_settings",this.getLocale()),type:"expandable",flatten:!1,expanded:!1,locale:this.getLocale(),schema:[{name:"keep_margin",locale:this.getLocale(),selector:{boolean:{}}},{name:"keep_background",locale:this.getLocale(),selector:{boolean:{}}},{name:"keep_box_shadow",locale:this.getLocale(),selector:{boolean:{}}},{name:"keep_border_radius",locale:this.getLocale(),selector:{boolean:{}}},{name:"keep_outer_padding",locale:this.getLocale(),selector:{boolean:{}}}]},{name:"card_background_override",locale:this.getLocale(),selector:{text:{}}}]},{name:"inner_cards",locale:this.getLocale(),selector:{constant:{value:this.localize("inner_cards",this.getLocale())}}}];return L`
      <ha-form
        .hass=${this.hass}
        .data=${this.config}
        .schema=${p}
      ...
      <div class="card-config">
        <div class="toolbar">
          <sl-tab-group @sl-tab-show=${e=>{this._handleSelectedCard(e)}}>
            ${null===(r=this.config.cards)||void 0===r?void 0:r.map(((e,t)=>L`<sl-tab slot="nav" .panel=${t.toString()} .active=${t===c}>
                  ${t+1}
                </sl-tab>`))}
          </sl-tab-group>
          <ha-icon-button
        ...
        <div id="editor">
          ${c<h?L`
                ...
                ${no(this._getKey(null!==(d=this.config.cards)&&void 0!==d?d:[],c),L`<hui-card-element-editor
                    .hass=${this.hass}
