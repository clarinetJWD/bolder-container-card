...
:host { 
  ${s(t.join("\n"))} 
}`}};e([qe({attribute:!1})],Vr.prototype,"_config",void 0),Vr=jr=e([Fe("bolder-header-card")],Vr);
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */var Jr;null===(Jr=window.HTMLSlotElement)||void 0===Jr||Jr.prototype.assignedElements;function Xr(e){if(!e||"object"!=typeof e)return e;if("[object Date]"==Object.prototype.toString.call(e))return new Date(e.getTime());if(Array.isArray(e))return e.map(Xr);var t={};return Object.keys(e).forEach((function(r){t[r]=Xr(e[r])})),t}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let Qr=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,r){this._$Ct=e,this._$AM=t,this._$Ci=r}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Yr={},eo=(e=>(...t)=>({_$litDirective$:e,values:t}))(class extends Qr{constructor(){super(...arguments),this.key=j}render(e,t){return this.key=e,t}update(e,[t,r]){return t!==this.key&&(((e,t=Yr)=>{e._$AH=t;
/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */})(e),this.key=t),r}}),to=globalThis,ro=to.ShadowRoot&&(void 0===to.ShadyCSS||to.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,oo=Symbol(),io=new WeakMap;let no=class{constructor(e,t,r){if(this._$cssResult$=!0,r!==oo)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(ro&&void 0===e){const r=void 0!==t&&1===t.length;r&&(e=io.get(t)),void 0===e&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),r&&io.set(t,e))}return e}toString(){return this.cssText}};const ao=(e,...t)=>{const r=1===e.length?e[0]:t.reduce(((t,r,o)=>t+(e=>{if(!0===e._$cssResult$)return e.cssText;if("number"==typeof e)return e;throw Error("Value passed to 'css' function must be a 'css' function result: "+e+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(r)+e[o+1]),e[0]);return new no(r,e,oo)},so=ro?e=>e:e=>e instanceof CSSStyleSheet?(e=>{let t="";for(const r of e.cssRules)t+=r.cssText;return(e=>new no("string"==typeof e?e:e+"",void 0,oo))(t)})(e):e
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */,{is:lo,defineProperty:co,getOwnPropertyDescriptor:ho,getOwnPropertyNames:uo,getOwnPropertySymbols:po,getPrototypeOf:_o}=Object,bo=globalThis,go=bo.trustedTypes,vo=go?go.emptyScript:"",fo=bo.reactiveElementPolyfillSupport,mo=(e,t)=>e,yo={toAttribute(e,t){switch(t){case Boolean:e=e?vo:null;break;case Object:case Array:e=null==e?e:JSON.stringify(e)}return e},fromAttribute(e,t){let r=e;switch(t){case Boolean:r=null!==e;break;case Number:r=null===e?null:Number(e);break;case Object:case Array:try{r=JSON.parse(e)}catch(e){r=null}}return r}},ko=(e,t)=>!lo(e,t),wo={attribute:!0,type:String,converter:yo,reflect:!1,useDefault:!1,hasChanged:ko};Symbol.metadata??=Symbol("metadata"),bo.litPropertyMetadata??=new WeakMap;let Co=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=wo){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){const r=Symbol(),o=this.getPropertyDescriptor(e,r,t);void 0!==o&&co(this.prototype,e,o)}}static getPropertyDescriptor(e,t,r){const{get:o,set:i}=ho(this.prototype,e)??{get(){return this[t]},set(e){this[t]=e}};return{get:o,set(t){const n=o?.call(this);i?.call(this,t),this.requestUpdate(e,n,r)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??wo}static _$Ei(){if(this.hasOwnProperty(mo("elementProperties")))return;const e=_o(this);e.finalize(),void 0!==e.l&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(mo("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(mo("properties"))){const e=this.properties,t=[...uo(e),...po(e)];for(const r of t)this.createProperty(r,e[r])}const e=this[Symbol.metadata];if(null!==e){const t=litPropertyMetadata.get(e);if(void 0!==t)for(const[e,r]of t)this.elementProperties.set(e,r)}this._$Eh=new Map;for(const[e,t]of this.elementProperties){const r=this._$Eu(e,t);void 0!==r&&this._$Eh.set(r,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const r=new Set(e.flat(1/0).reverse());for(const e of r)t.unshift(so(e))}else void 0!==e&&t.push(so(e));return t}static _$Eu(e,t){const r=t.attribute;return!1===r?void 0:"string"==typeof r?r:"string"==typeof e?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise((e=>this.enableUpdating=e)),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach((e=>e(this)))}addController(e){(this._$EO??=new Set).add(e),void 0!==this.renderRoot&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){const e=new Map,t=this.constructor.elementProperties;for(const r of t.keys())this.hasOwnProperty(r)&&(e.set(r,this[r]),delete this[r]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return((e,t)=>{if(ro)e.adoptedStyleSheets=t.map((e=>e instanceof CSSStyleSheet?e:e.styleSheet));else for(const r of t){const t=document.createElement("style"),o=to.litNonce;void 0!==o&&t.setAttribute("nonce",o),t.textContent=r.cssText,e.appendChild(t)}})(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach((e=>e.hostConnected?.()))}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach((e=>e.hostDisconnected?.()))}attributeChangedCallback(e,t,r){this._$AK(e,r)}_$ET(e,t){const r=this.constructor.elementProperties.get(e),o=this.constructor._$Eu(e,r);if(void 0!==o&&!0===r.reflect){const i=(void 0!==r.converter?.toAttribute?r.converter:yo).toAttribute(t,r.type);this._$Em=e,null==i?this.removeAttribute(o):this.setAttribute(o,i),this._$Em=null}}_$AK(e,t){const r=this.constructor,o=r._$Eh.get(e);if(void 0!==o&&this._$Em!==o){const e=r.getPropertyOptions(o),i="function"==typeof e.converter?{fromAttribute:e.converter}:void 0!==e.converter?.fromAttribute?e.converter:yo;this._$Em=o,this[o]=i.fromAttribute(t,e.type)??this._$Ej?.get(o)??null,this._$Em=null}}requestUpdate(e,t,r){if(void 0!==e){const o=this.constructor,i=this[e];if(r??=o.getPropertyOptions(e),!((r.hasChanged??ko)(i,t)||r.useDefault&&r.reflect&&i===this._$Ej?.get(e)&&!this.hasAttribute(o._$Eu(e,r))))return;this.C(e,t,r)}!1===this.isUpdatePending&&(this._$ES=this._$EP())}C(e,t,{useDefault:r,reflect:o,wrapped:i},n){r&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,n??t??this[e]),!0!==i||void 0!==n)||(this._$AL.has(e)||(this.hasUpdated||r||(t=void 0),this._$AL.set(e,t)),!0===o&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}const e=this.scheduleUpdate();return null!=e&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[e,t]of this._$Ep)this[e]=t;this._$Ep=void 0}const e=this.constructor.elementProperties;if(e.size>0)for(const[t,r]of e){const{wrapped:e}=r,o=this[t];!0!==e||this._$AL.has(t)||void 0===o||this.C(t,void 0,r,o)}}let e=!1;const t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach((e=>e.hostUpdate?.())),this.update(t)):this._$EM()}catch(t){throw e=!1,this._$EM(),t}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach((e=>e.hostUpdated?.())),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach((e=>this._$ET(e,this[e]))),this._$EM()}updated(e){}firstUpdated(e){}};Co.elementStyles=[],Co.shadowRootOptions={mode:"open"},Co[mo("elementProperties")]=new Map,Co[mo("finalized")]=new Map,fo?.({ReactiveElement:Co}),(bo.reactiveElementVersions??=[]).push("2.1.0");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const $o=globalThis,So=$o.trustedTypes,xo=So?So.createPolicy("lit-html",{createHTML:e=>e}):void 0,Ao="$lit$",Eo=`lit$${Math.random().toFixed(9).slice(2)}$`,Oo="?"+Eo,zo=`<${Oo}>`,To=document,Po=()=>To.createComment(""),Bo=e=>null===e||"object"!=typeof e&&"function"!=typeof e,Mo=Array.isArray,Ko="[ \t\n\f\r]",Ho=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Io=/-->/g,Ro=/>/g,Lo=RegExp(`>|${Ko}(?:([^\\s"'>=/]+)(${Ko}*=${Ko}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),No=/'/g,Uo=/"/g,jo=/^(?:script|style|textarea|title)$/i,Vo=(e=>(t,...r)=>({_$litType$:e,strings:t,values:r}))(1),Do=Symbol.for("lit-noChange"),Fo=Symbol.for("lit-nothing"),Wo=new WeakMap,qo=To.createTreeWalker(To,129);function Zo(e,t){if(!Mo(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==xo?xo.createHTML(t):t}const Go=(e,t)=>{const r=e.length-1,o=[];let i,n=2===t?"<svg>":3===t?"<math>":"",a=Ho;for(let t=0;t<r;t++){const r=e[t];let s,l,d=-1,c=0;for(;c<r.length&&(a.lastIndex=c,l=a.exec(r),null!==l);)c=a.lastIndex,a===Ho?"!--"===l[1]?a=Io:void 0!==l[1]?a=Ro:void 0!==l[2]?(jo.test(l[2])&&(i=RegExp("</"+l[2],"g")),a=Lo):void 0!==l[3]&&(a=Lo):a===Lo?">"===l[0]?(a=i??Ho,d=-1):void 0===l[1]?d=-2:(d=a.lastIndex-l[2].length,s=l[1],a=void 0===l[3]?Lo:'"'===l[3]?Uo:No):a===Uo||a===No?a=Lo:a===Io||a===Ro?a=Ho:(a=Lo,i=void 0);const h=a===Lo&&e[t+1].startsWith("/>")?" ":"";n+=a===Ho?r+zo:d>=0?(o.push(s),r.slice(0,d)+Ao+r.slice(d)+Eo+h):r+Eo+(-2===d?t:h)}return[Zo(e,n+(e[r]||"<?>")+(2===t?"</svg>":3===t?"</math>":"")),o]};class Jo{constructor({strings:e,_$litType$:t},r){let o;this.parts=[];let i=0,n=0;const a=e.length-1,s=this.parts,[l,d]=Go(e,t);if(this.el=Jo.createElement(l,r),qo.currentNode=this.el.content,2===t||3===t){const e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;null!==(o=qo.nextNode())&&s.length<a;){if(1===o.nodeType){if(o.hasAttributes())for(const e of o.getAttributeNames())if(e.endsWith(Ao)){const t=d[n++],r=o.getAttribute(e).split(Eo),a=/([.?@])?(.*)/.exec(t);s.push({type:1,index:i,name:a[2],strings:r,ctor:"."===a[1]?ti:"?"===a[1]?ri:"@"===a[1]?oi:ei}),o.removeAttribute(e)}else e.startsWith(Eo)&&(s.push({type:6,index:i}),o.removeAttribute(e));if(jo.test(o.tagName)){const e=o.textContent.split(Eo),t=e.length-1;if(t>0){o.textContent=So?So.emptyScript:"";for(let r=0;r<t;r++)o.append(e[r],Po()),qo.nextNode(),s.push({type:2,index:++i});o.append(e[t],Po())}}}else if(8===o.nodeType)if(o.data===Oo)s.push({type:2,index:i});else{let e=-1;for(;-1!==(e=o.data.indexOf(Eo,e+1));)s.push({type:7,index:i}),e+=Eo.length-1}i++}}static createElement(e,t){const r=To.createElement("template");return r.innerHTML=e,r}}function Xo(e,t,r=e,o){if(t===Do)return t;let i=void 0!==o?r._$Co?.[o]:r._$Cl;const n=Bo(t)?void 0:t._$litDirective$;return i?.constructor!==n&&(i?._$AO?.(!1),void 0===n?i=void 0:(i=new n(e),i._$AT(e,r,o)),void 0!==o?(r._$Co??=[])[o]=i:r._$Cl=i),void 0!==i&&(t=Xo(e,i._$AS(e,t.values),i,o)),t}class Qo{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:r}=this._$AD,o=(e?.creationScope??To).importNode(t,!0);qo.currentNode=o;let i=qo.nextNode(),n=0,a=0,s=r[0];for(;void 0!==s;){if(n===s.index){let t;2===s.type?t=new Yo(i,i.nextSibling,this,e):1===s.type?t=new s.ctor(i,s.name,s.strings,this,e):6===s.type&&(t=new ii(i,this,e)),this._$AV.push(t),s=r[++a]}n!==s?.index&&(i=qo.nextNode(),n++)}return qo.currentNode=To,o}p(e){let t=0;for(const r of this._$AV)void 0!==r&&(void 0!==r.strings?(r._$AI(e,r,t),t+=r.strings.length-2):r._$AI(e[t])),t++}}class Yo{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,r,o){this.type=2,this._$AH=Fo,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=r,this.options=o,this._$Cv=o?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return void 0!==t&&11===e?.nodeType&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Xo(this,e,t),Bo(e)?e===Fo||null==e||""===e?(this._$AH!==Fo&&this._$AR(),this._$AH=Fo):e!==this._$AH&&e!==Do&&this._(e):void 0!==e._$litType$?this.$(e):void 0!==e.nodeType?this.T(e):(e=>Mo(e)||"function"==typeof e?.[Symbol.iterator])(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==Fo&&Bo(this._$AH)?this._$AA.nextSibling.data=e:this.T(To.createTextNode(e)),this._$AH=e}$(e){const{values:t,_$litType$:r}=e,o="number"==typeof r?this._$AC(e):(void 0===r.el&&(r.el=Jo.createElement(Zo(r.h,r.h[0]),this.options)),r);if(this._$AH?._$AD===o)this._$AH.p(t);else{const e=new Qo(o,this),r=e.u(this.options);e.p(t),this.T(r),this._$AH=e}}_$AC(e){let t=Wo.get(e.strings);return void 0===t&&Wo.set(e.strings,t=new Jo(e)),t}k(e){Mo(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let r,o=0;for(const i of e)o===t.length?t.push(r=new Yo(this.O(Po()),this.O(Po()),this,this.options)):r=t[o],r._$AI(i),o++;o<t.length&&(this._$AR(r&&r._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e&&e!==this._$AB;){const t=e.nextSibling;e.remove(),e=t}}setConnected(e){void 0===this._$AM&&(this._$Cv=e,this._$AP?.(e))}}class ei{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,r,o,i){this.type=1,this._$AH=Fo,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=i,r.length>2||""!==r[0]||""!==r[1]?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=Fo}_$AI(e,t=this,r,o){const i=this.strings;let n=!1;if(void 0===i)e=Xo(this,e,t,0),n=!Bo(e)||e!==this._$AH&&e!==Do,n&&(this._$AH=e);else{const o=e;let a,s;for(e=i[0],a=0;a<i.length-1;a++)s=Xo(this,o[r+a],t,a),s===Do&&(s=this._$AH[a]),n||=!Bo(s)||s!==this._$AH[a],s===Fo?e=Fo:e!==Fo&&(e+=(s??"")+i[a+1]),this._$AH[a]=s}n&&!o&&this.j(e)}j(e){e===Fo?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class ti extends ei{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===Fo?void 0:e}}class ri extends ei{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==Fo)}}class oi extends ei{constructor(e,t,r,o,i){super(e,t,r,o,i),this.type=5}_$AI(e,t=this){if((e=Xo(this,e,t,0)??Fo)===Do)return;const r=this._$AH,o=e===Fo&&r!==Fo||e.capture!==r.capture||e.once!==r.once||e.passive!==r.passive,i=e!==Fo&&(r===Fo||o);o&&this.element.removeEventListener(this.name,this,r),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class ii{constructor(e,t,r){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(e){Xo(this,e)}}const ni=$o.litHtmlPolyfillSupport;ni?.(Jo,Yo),($o.litHtmlVersions??=[]).push("3.3.0");const ai=globalThis;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let si=class extends Co{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=((e,t,r)=>{const o=r?.renderBefore??t;let i=o._$litPart$;if(void 0===i){const e=r?.renderBefore??null;o._$litPart$=i=new Yo(t.insertBefore(Po(),e),e,void 0,r??{})}return i._$AI(e),i})(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return Do}};si._$litElement$=!0,si.finalized=!0,ai.litElementHydrateSupport?.({LitElement:si});const li=ai.litElementPolyfillSupport;li?.({LitElement:si}),(ai.litElementVersions??=[]).push("4.2.0");var di=ao`
  :host {
...
`,hi=Object.defineProperty,ui=Object.getOwnPropertyDescriptor,pi=Object.getOwnPropertySymbols,_i=Object.prototype.hasOwnProperty,bi=Object.prototype.propertyIsEnumerable,gi=e=>{throw TypeError(e)},vi=(e,t,r)=>t in e?hi(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,fi=(e,t)=>{for(var r in t||(t={}))_i.call(t,r)&&vi(e,r,t[r]);if(pi)for(var r of pi(t))bi.call(t,r)&&vi(e,r,t[r]);return e},mi=(e,t,r,o)=>{for(var i,n=o>1?void 0:o?ui(t,r):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(o?i(t,r,n):i(n))||n);return o&&n&&hi(t,r,n),n},yi=(e,t,r)=>t.has(e)||gi("Cannot "+r);function ki(e,t){const r=fi({waitUntilFirstUpdate:!1},t);return(t,o)=>{const{update:i}=t,n=Array.isArray(e)?e:[e];t.update=function(e){n.forEach((t=>{const i=t;if(e.has(i)){const t=e.get(i),n=this[i];t!==n&&(r.waitUntilFirstUpdate&&!this.hasUpdated||this[o](t,n))}})),i.call(this,e)}}}var wi=ao`
  :host {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
function Ai(e,t){return(t,r,o)=>((e,t,r)=>(r.configurable=!0,r.enumerable=!0,Reflect.decorate&&"object"!=typeof t&&Object.defineProperty(e,t,r),r))(t,r,{get(){return(t=>t.renderRoot?.querySelector(e)??null)(this)}})}var Ei,Oi=class extends si{constructor(){var e,t,r;super(),e=this,r=!1,(t=Ei).has(e)?gi("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),this.initialReflectedProperties=new Map,Object.entries(this.constructor.dependencies).forEach((([e,t])=>{this.constructor.define(e,t)}))}emit(e,t){const r=new CustomEvent(e,fi({bubbles:!0,cancelable:!1,composed:!0,detail:{}},t));return this.dispatchEvent(r),r}static define(e,t=this,r={}){const o=customElements.get(e);if(!o){try{customElements.define(e,t,r)}catch(o){customElements.define(e,class extends t{},r)}return}let i=" (unknown version)",n=i;"version"in t&&t.version&&(i=" v"+t.version),"version"in o&&o.version&&(n=" v"+o.version),i&&n&&i===n||console.warn(`Attempted to register <${e}>${i}, but <${e}>${n} has already been registered.`)}attributeChangedCallback(e,t,r){var o,i;yi(o=this,i=Ei,"read from private field"),i.get(o)||(this.constructor.elementProperties.forEach(((e,t)=>{e.reflect&&null!=this[t]&&this.initialReflectedProperties.set(t,this[t])})),((e,t,r,o)=>{yi(e,t,"write to private field"),t.set(e,r)})(this,Ei,!0)),super.attributeChangedCallback(e,t,r)}willUpdate(e){super.willUpdate(e),this.initialReflectedProperties.forEach(((t,r)=>{e.has(r)&&null==this[r]&&(this[r]=t)}))}};Ei=new WeakMap,Oi.version="2.20.1",Oi.dependencies={},mi([Si()],Oi.prototype,"dir",2),mi([Si()],Oi.prototype,"lang",2);var zi=class extends Oi{constructor(){super(...arguments),this.observedElements=[],this.disabled=!1}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver((e=>{this.emit("sl-resize",{detail:{entries:e}})})),this.disabled||this.startObserver()}disconnectedCallback(){super.disconnectedCallback(),this.stopObserver()}handleSlotChange(){this.disabled||this.startObserver()}startObserver(){const e=this.shadowRoot.querySelector("slot");if(null!==e){const t=e.assignedElements({flatten:!0});this.observedElements.forEach((e=>this.resizeObserver.unobserve(e))),this.observedElements=[],t.forEach((e=>{this.resizeObserver.observe(e),this.observedElements.push(e)}))}}stopObserver(){this.resizeObserver.disconnect()}handleDisabledChange(){this.disabled?this.stopObserver():this.startObserver()}render(){return Vo` <slot @slotchange=${this.handleSlotChange}></slot> `}};function Ti(e,t,r="vertical",o="smooth"){const i=function(e,t){return{top:Math.round(e.getBoundingClientRect().top-t.getBoundingClientRect().top),left:Math.round(e.getBoundingClientRect().left-t.getBoundingClientRect().left)}}(e,t),n=i.top+t.scrollTop,a=i.left+t.scrollLeft,s=t.scrollLeft,l=t.scrollLeft+t.offsetWidth,d=t.scrollTop,c=t.scrollTop+t.offsetHeight;"horizontal"!==r&&"both"!==r||(a<s?t.scrollTo({left:a,behavior:o}):a+e.clientWidth>l&&t.scrollTo({left:a-t.offsetWidth+e.clientWidth,behavior:o})),"vertical"!==r&&"both"!==r||(n<d?t.scrollTo({top:n,behavior:o}):n+e.clientHeight>c&&t.scrollTo({top:n-t.offsetHeight+e.clientHeight,behavior:o}))}zi.styles=[wi,ci],mi([Si({type:Boolean,reflect:!0})],zi.prototype,"disabled",2),mi([ki("disabled",{waitUntilFirstUpdate:!0})],zi.prototype,"handleDisabledChange",1);var Pi=ao`
  :host {
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */;var Ui,ji=Symbol(),Vi=Symbol(),Di=new Map,Fi=class extends Oi{constructor(){super(...arguments),this.initialRender=!1,this.svg=null,this.label="",this.library="default"}async resolveIcon(e,t){var r;let o;if(null==t?void 0:t.spriteSheet)return this.svg=Vo`<svg part="svg">
        <use part="use" href="${e}"></use>
      </svg>`,this.svg;try{if(o=await fetch(e,{mode:"cors"}),!o.ok)return 410===o.status?ji:Vi}catch(e){return Vi}try{const e=document.createElement("div");e.innerHTML=await o.text();const t=e.firstElementChild;if("svg"!==(null==(r=null==t?void 0:t.tagName)?void 0:r.toLowerCase()))return ji;Ui||(Ui=new DOMParser);const i=Ui.parseFromString(t.outerHTML,"text/html").body.querySelector("svg");return i?(i.part.add("svg"),document.adoptNode(i)):ji}catch(e){return ji}}connectedCallback(){var e;super.connectedCallback(),e=this,Ri.push(e)}firstUpdated(){this.initialRender=!0,this.setIcon()}disconnectedCallback(){var e;super.disconnectedCallback(),e=this,Ri=Ri.filter((t=>t!==e))}getIconSource(){const e=Li(this.library);return this.name&&e?{url:e.resolver(this.name),fromLibrary:!0}:{url:this.src,fromLibrary:!1}}handleLabelChange(){"string"==typeof this.label&&this.label.length>0?(this.setAttribute("role","img"),this.setAttribute("aria-label",this.label),this.removeAttribute("aria-hidden")):(this.removeAttribute("role"),this.removeAttribute("aria-label"),this.setAttribute("aria-hidden","true"))}async setIcon(){var e;const{url:t,fromLibrary:r}=this.getIconSource(),o=r?Li(this.library):void 0;if(!t)return void(this.svg=null);let i=Di.get(t);if(i||(i=this.resolveIcon(t,o),Di.set(t,i)),!this.initialRender)return;const n=await i;if(n===Vi&&Di.delete(t),t===this.getIconSource().url)if(((e,t)=>void 0!==e?._$litType$)(n)){if(this.svg=n,o){await this.updateComplete;const e=this.shadowRoot.querySelector("[part='svg']");"function"==typeof o.mutator&&e&&o.mutator(e)}}else switch(n){case Vi:case ji:this.svg=null,this.emit("sl-error");break;default:this.svg=n.cloneNode(!0),null==(e=null==o?void 0:o.mutator)||e.call(o,this.svg),this.emit("sl-load")}}render(){return this.svg}};Fi.styles=[wi,Ni],mi([xi()],Fi.prototype,"svg",2),mi([Si({reflect:!0})],Fi.prototype,"name",2),mi([Si()],Fi.prototype,"src",2),mi([Si()],Fi.prototype,"label",2),mi([Si({reflect:!0})],Fi.prototype,"library",2),mi([ki("label")],Fi.prototype,"handleLabelChange",1),mi([ki(["name","src","library"])],Fi.prototype,"setIcon",1);
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Wi=1;let qi=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,r){this._$Ct=e,this._$AM=t,this._$Ci=r}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Zi=(e=>(...t)=>({_$litDirective$:e,values:t}))(class extends qi{constructor(e){if(super(e),e.type!==Wi||"class"!==e.name||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter((t=>e[t])).join(" ")+" "}update(e,[t]){if(void 0===this.st){this.st=new Set,void 0!==e.strings&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter((e=>""!==e))));for(const e in t)t[e]&&!this.nt?.has(e)&&this.st.add(e);return this.render(t)}const r=e.element.classList;for(const e of this.st)e in t||(r.remove(e),this.st.delete(e));for(const e in t){const o=!!t[e];o===this.st.has(e)||this.nt?.has(e)||(o?(r.add(e),this.st.add(e)):(r.remove(e),this.st.delete(e)))}return Do}}),Gi=Symbol.for(""),Ji=e=>{if(e?.r===Gi)return e?._$litStatic$},Xi=(e,...t)=>({_$litStatic$:t.reduce(((t,r,o)=>t+(e=>{if(void 0!==e._$litStatic$)return e._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${e}. Use 'unsafeStatic' to pass non-literal values, but\n            take care to ensure page security.`)})(r)+e[o+1]),e[0]),r:Gi}),Qi=new Map,Yi=(e=>(t,...r)=>{const o=r.length;let i,n;const a=[],s=[];let l,d=0,c=!1;for(;d<o;){for(l=t[d];d<o&&void 0!==(n=r[d],i=Ji(n));)l+=i+t[++d],c=!0;d!==o&&s.push(n),a.push(l),d++}if(d===o&&a.push(t[o]),c){const e=a.join("$$lit$$");void 0===(t=Qi.get(e))&&(a.raw=a,Qi.set(e,t=a)),r=s}return e(t,...r)})(Vo),en=e=>e??Fo;
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var tn=class extends Oi{constructor(){super(...arguments),this.hasFocus=!1,this.label="",this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(e){this.disabled&&(e.preventDefault(),e.stopPropagation())}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}render(){const e=!!this.href,t=e?Xi`a`:Xi`button`;return Yi`
      <${t}
        part="base"
        class=${Zi({"icon-button":!0,"icon-button--disabled":!e&&this.disabled,"icon-button--focused":this.hasFocus})}
        ?disabled=${en(e?void 0:this.disabled)}
        type=${en(e?void 0:"button")}
        href=${en(e?this.href:void 0)}
        target=${en(e?this.target:void 0)}
        download=${en(e?this.download:void 0)}
        rel=${en(e&&this.target?"noreferrer noopener":void 0)}
        role=${en(e?void 0:"button")}
        ...
        <div class="tab-group__nav-container" part="nav">
          ${this.hasScrollControls?Vo`
                <sl-icon-button
                  ...
                  class=${Zi({"tab-group__scroll-button":!0,"tab-group__scroll-button--start":!0,"tab-group__scroll-button--start--hidden":this.shouldHideScrollStartButton})}
          ...
          ${this.hasScrollControls?Vo`
                <sl-icon-button
                  ...
                  exportparts="base:scroll-button__base"
                  class=${Zi({"tab-group__scroll-button":!0,"tab-group__scroll-button--end":!0,"tab-group__scroll-button--end--hidden":this.shouldHideScrollEndButton})}
    ...
    `}};bn.styles=[wi,di],bn.dependencies={"sl-icon-button":tn,"sl-resize-observer":zi},mi([Ai(".tab-group")],bn.prototype,"tabGroup",2),mi([Ai(".tab-group__body")],bn.prototype,"body",2),mi([Ai(".tab-group__nav")],bn.prototype,"nav",2),mi([Ai(".tab-group__indicator")],bn.prototype,"indicator",2),mi([xi()],bn.prototype,"hasScrollControls",2),mi([xi()],bn.prototype,"shouldHideScrollStartButton",2),mi([xi()],bn.prototype,"shouldHideScrollEndButton",2),mi([Si()],bn.prototype,"placement",2),mi([Si()],bn.prototype,"activation",2),mi([Si({attribute:"no-scroll-controls",type:Boolean})],bn.prototype,"noScrollControls",2),mi([Si({attribute:"fixed-scroll-controls",type:Boolean})],bn.prototype,"fixedScrollControls",2),mi([function(e){return(t,r)=>{const o="function"==typeof t?t:t[r];Object.assign(o,e)}}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */({passive:!0})],bn.prototype,"updateScrollButtons",1),mi([ki("noScrollControls",{waitUntilFirstUpdate:!0})],bn.prototype,"updateScrollControls",1),mi([ki("placement",{waitUntilFirstUpdate:!0})],bn.prototype,"syncIndicator",1);var gn=(e,t)=>{let r=0;return function(...o){window.clearTimeout(r),r=window.setTimeout((()=>{e.call(this,...o)}),t)}},vn=(e,t,r)=>{const o=e[t];e[t]=function(...e){o.call(this,...e),r.call(this,o,...e)}};(()=>{if("undefined"==typeof window)return;if(!("onscrollend"in window)){const e=new Set,t=new WeakMap,r=t=>{for(const r of t.changedTouches)e.add(r.identifier)},o=t=>{for(const r of t.changedTouches)e.delete(r.identifier)};document.addEventListener("touchstart",r,!0),document.addEventListener("touchend",o,!0),document.addEventListener("touchcancel",o,!0),vn(EventTarget.prototype,"addEventListener",(function(r,o){if("scrollend"!==o)return;const i=gn((()=>{e.size?i():this.dispatchEvent(new Event("scrollend"))}),100);r.call(this,"scroll",i,{passive:!0}),t.set(this,i)})),vn(EventTarget.prototype,"removeEventListener",(function(e,r){if("scrollend"!==r)return;const o=t.get(this);o&&e.call(this,"scroll",o,{passive:!0})}))}})();var fn=ao`
  :host {
    display: inline-block;
  }
...
`,mn=0,yn=class extends Oi{constructor(){super(...arguments),this.localize=new _n(this),this.attrId=++mn,this.componentId=`sl-tab-${this.attrId}`,this.panel="",this.active=!1,this.closable=!1,this.disabled=!1,this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.setAttribute("role","tab")}handleCloseClick(e){e.stopPropagation(),this.emit("sl-close")}handleActiveChange(){this.setAttribute("aria-selected",this.active?"true":"false")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false"),this.disabled&&!this.active?this.tabIndex=-1:this.tabIndex=0}render(){return this.id=this.id.length>0?this.id:this.componentId,Vo`
      <div
        part="base"
        class=${Zi({tab:!0,"tab--active":this.active,"tab--closable":this.closable,"tab--disabled":this.disabled})}
      >
        <slot></slot>
        ${this.closable?Vo`
              <sl-icon-button
    ...
    `}};yn.styles=[wi,fn],yn.dependencies={"sl-icon-button":tn},mi([Ai(".tab")],yn.prototype,"tab",2),mi([Si({reflect:!0})],yn.prototype,"panel",2),mi([Si({type:Boolean,reflect:!0})],yn.prototype,"active",2),mi([Si({type:Boolean,reflect:!0})],yn.prototype,"closable",2),mi([Si({type:Boolean,reflect:!0})],yn.prototype,"disabled",2),mi([Si({type:Number,reflect:!0})],yn.prototype,"tabIndex",2),mi([ki("active")],yn.prototype,"handleActiveChange",1),mi([ki("disabled")],yn.prototype,"handleDisabledChange",1),yn.define("sl-tab");let kn=class extends bn{constructor(){super(...arguments),this._mouseIsDown=!1,this._scrolled=!1,this._scrollStartX=0,this._scrollLeft=0,this._mouseDown=e=>{const t=this._scrollContainer;t&&(this._scrollStartX=e.pageX-t.offsetLeft,this._scrollLeft=t.scrollLeft,this._mouseIsDown=!0,this._scrolled=!1,window.addEventListener("mousemove",this._mouseMove),window.addEventListener("mouseup",this._mouseUp,{once:!0}))},this._mouseUp=()=>{this._mouseIsDown=!1,this._scrolled&&(this._mouseReleasedAt=(new Date).getTime()),window.removeEventListener("mousemove",this._mouseMove)},this._mouseMove=e=>{if(!this._mouseIsDown)return;const t=this._scrollContainer;if(!t)return;const r=e.pageX-t.offsetLeft-this._scrollStartX;this._scrolled||(this._scrolled=Math.abs(r)>1),t.scrollLeft=this._scrollLeft-r}}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousemove",this._mouseMove),window.removeEventListener("mouseup",this._mouseUp)}setAriaLabels(){}getAllPanels(){return[]}firstUpdated(e){super.firstUpdated(e);const t=this._scrollContainer;t&&t.addEventListener("mousedown",this._mouseDown)}handleClick(e){this._mouseReleasedAt&&(new Date).getTime()-this._mouseReleasedAt<100||super.handleClick(e)}};kn.styles=[di,l`
      :host {
      ...
      <div class="card-config">
        ...
        <div id="editor">
          ${c<h?N`
                ...
                ${eo(this._getKey(null!==(d=this.config.cards)&&void 0!==d?d:[],c),N`<hui-card-element-editor
                    .hass=${this.hass}
